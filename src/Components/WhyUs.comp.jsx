...
export default function WhyUs() {
  return (
    <>
      <section className="relative pb-36   flex justify-center bg-black py-16 items-center  w-full  z-[100]  whySection">
        ...
        <div className="flex h-full  flex-col items-start justify-center w-[45%] gap-5 z-[300]">
          ...
          <h2 className=" font-bold  text-white text-[40px] bring_right_why_us">
            25 years of <span className="text-[#6D95FC]">experience</span> as a
            creative agency
          </h2>
<AnimatedButton text={"Read More"} specialClass={"bring_right_why_us"} />
       
        </div>
        <div className="flex h-full  flex-col items-start justify-center w-[35%] gap-5">
